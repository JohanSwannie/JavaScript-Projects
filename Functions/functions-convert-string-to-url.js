function converToURL(stringValue) {
...
document.getElementById('string1').innerHTML = converToURL(string1);
document.getElementById('string2').innerHTML = converToURL(string2);
